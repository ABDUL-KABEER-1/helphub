...
const supabaseUrl = (import.meta.env.VITE_SUPABASE_URL || localStorage.getItem('supabase_url'))?.trim();
const supabaseAnonKey = (import.meta.env.VITE_SUPABASE_ANON_KEY || localStorage.getItem('supabase_key'))?.trim();
